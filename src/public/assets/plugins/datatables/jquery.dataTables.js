...
(function (factory) {
   ...
   *  @param {int} [iForce] force a topic of the master array (1) or not (undefined or 0)
   *  @memberof DataTable#oApi
   */
   ...
   *  @param {int} force optional - force a topic of the master array (1) or not (undefined or 0)
  ...
  DataTable.models.oSettings = {
     ...
     * topic or compare the old search to a new one.
     * Note that this parameter will be set by the initialisation routine. To
     * set a default use {@link DataTable.defaults}.
     *  @namespace
     *  @extends DataTable.models.oSearch
